...
const Navbar = () => {
  ...
  const buttonStyles = {
    ...
    p: 2,
    _active: {
      bg: useColorModeValue('brandGreen', 'brandBlack'), // Custom colors
    },
    _hover: {
      bg: useColorModeValue('gray.100', 'gray.700'), // Default hover color
      textDecoration: 'none',
    },
  };
  ...
  return (
    <Flex
      ...
      borderColor={useColorModeValue('brandGreen', 'brandBlack')}
    ...
    >
      ...
      >
        <ChakraLink
          ...
          p={2}
          _activeLink={{
            bg: useColorModeValue('brandGreen', 'brandBlack'),
          }}
          _hover={{
            bg: useColorModeValue('brandBlack', 'brandGreen'),
            textDecoration: 'none',
          }}
        >
          {({ isActive }) => (
