...
export function makeServer({ environment = 'development' } = {}) {
  return new Server({
    ...
    routes() {
      ...
      this.passthrough();
      this.passthrough(
        'https://api.cloudinary.com/v1_1/dcb5jfpo9/image/upload',
        'https://api.cloudinary.com/v1_1/dcb5jfpo9/video/upload',
        'https://api.cloudinary.com/v1_1/dcb5jfpo9/delete_by_token',
        ['post']
      );
    },
  });
